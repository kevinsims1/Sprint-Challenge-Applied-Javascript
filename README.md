...
1. What is the DOM?
//The HTML your write is parsed/translated by the browser and turned into the DOM.//
2. What is an event?
//actions made by the user//
3. What is an event listener?
//Reactions based on the Users actions//
4. Why would we convert a NodeList into an Array?
//to avoid all hacks used by past Developers//
5. What is a component?
//A single piece of a bigger object//
### Git Set up
